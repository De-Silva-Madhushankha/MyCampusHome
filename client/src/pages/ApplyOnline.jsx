        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
          ...
          <div>
            ...
            <p className="text-gray-600">
              ...
              impression with Rentberry's convenient online application.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="order-2 md:order-1">
            ...
            <p className="text-gray-600">
              ...
              history. Create an extraordinary offer with Rentberry!
            </p>
          </div>
          <div className="order-1 md:order-2 flex justify-center">
            <div className="bg-white rounded-xl shadow-lg p-6 w-80 border border-gray-200">
              <div className="space-y-6">
                ...
                <Button className="w-full bg-green-500 hover:bg-green-600 text-white text-lg py-3 rounded-lg">
                  Submit Offer
                </Button>
              </div>
            </div>
